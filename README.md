...
This course is offered as part of the OPTIQ Master's program. It is intended for first-year master students.
...
* **Before the first class** make sure that [Anaconda](https://www.anaconda.com) and [VSCode](https://vscode.github.com) are properly installed on your PC and up-to-date.
